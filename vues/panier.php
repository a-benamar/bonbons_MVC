 ...
 <div class="col-md-12">
        ...
        <tbody>
           ...
           <?php 
			...
			<td> <a href='index.php?uc=bonbons&action=ajoutSuppPanier&id=<?php echo $produits->getId()?>' /><i class="fa fa-plus fa_3x" aria-hidden="true"></i> </a></td>
			<td> <a href='index.php?uc=bonbons&action=retraitPanier&id=<?php echo $produits->getId() ?>' /><i class="fa fa-minus " aria-hidden="true"></i></td>
          </tr>
